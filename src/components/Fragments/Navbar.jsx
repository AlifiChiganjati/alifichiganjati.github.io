...
const Navbar = () => {
  ...
  return (
    <header className="p-4 fixed w-full flex justify-between items-center bg-primary">
      <h1 className="text-xl text-text-primary md:text-2xl lg:text-3xl font-bold uppercase italic">
        Alifi Chiganjati
      </h1>
      ...
      >
        ...
        />
        <h1 className="p-4 text-xl text-dark-primary sm:hidden font-bold uppercase italic">
          Alifi Chiganjati
        </h1>
        <NavCarousel
