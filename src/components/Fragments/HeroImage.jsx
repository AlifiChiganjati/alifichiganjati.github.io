const HeroImage = ({
  ...
  return (
    ...
    >
      <div className="h-[400px] w-[300px] min-[400px]:h-[466px] min-[400px]:w-[350px] md:h-[500px] md:w-[400px] lg:absolute lg:bottom-0 lg:h-[633px] lg:w-[475px] 2xl:h-[733px] 2xl:w-[550px]">
